...
echo # Set it to 0 if you want to skip the process
echo AutoCrawlerIntervalHours: 1
echo BoardCrawlerIntervalHours: 12
echo.
echo # --- 8. EXTERNAL LINKS FILTERING ---
echo # Domains to actively scan for and trigger the external downloader module (pipe-separated)
echo ExternalWhitelist: "telegra.ph | kone.gg"
echo.
echo # Domains to completely ignore and exclude from external_links.txt (pipe-separated)
echo ExternalBlacklist: "youtube.com | youtu.be | twitter.com | x.com"
echo.
echo # --- 9. ADVANCED / SYSTEM ---
